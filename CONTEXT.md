...
| `docs/re/08-combat-damage.md` | **攻擊力公式全解**（含 20000 的來歷）、兵力扣減點、地形加成、難度參數、4 倍門檻 | ✅ |
...
| 1m | ⚠️ **`sub_530B4` 的呼叫端** | A／B 誰是攻方。決定兵種 4 特例的方向——實跑起來現在是「兵種 4 打不動人」，讀起來怪（`docs/playtest/04` §3）。**優先度最高** |
