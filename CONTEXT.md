...
| **戰損（M3）** | 🔶 **部分解**：一次交戰**同時扣雙方**兵力；**地形加成 confirmed**（鐵路／丘陵／關口 ×2、城市 ×3、其餘 1）；4 倍差距走不同路徑。**強度主項 `sub_5A0B9`(337 行) 與兩支戰損函式未讀**。見 `docs/re/08` |
...
| `docs/re/08-combat-damage.md` | **戰損鏈**：兵力扣在哪、戰力算式骨架、**地形加成**、4 倍門檻 | 🔶 |
