...
- **速度倍率**（`F0 7F 00 …`）真的被拿來當音樂手法：
  `FINAL` 結尾是一整串 0.945 → 0.898 → 0.797 → 0.695 → 0.594 → 0.500 → 0.445 的**漸慢**；
  `MAINTHEM` 開頭是 0.945 → 0.969 → 0.977 → 0.984 → 1.000 的**漸快**；
  `WALL` 在 t=15120 短暫掉到 0.5× 再回到 1.0。
